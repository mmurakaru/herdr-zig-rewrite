...
Herdr ships a reusable agent skill file at [`SKILL.md`](https://github.com/example-owner/herdr/blob/master/SKILL.md).
...
```bash
npx skills add example-owner/herdr --skill herdr -g
```
...
```text
https://github.com/example-owner/herdr/blob/master/SKILL.md
```
...
[Open `SKILL.md` on GitHub →](https://github.com/example-owner/herdr/blob/master/SKILL.md)
