...
```bash
herdr plugin install example-owner/herdr-plugin-examples/agent-telegram-notify
...
The example cookbook repo is `example-owner/herdr-plugin-examples`. It contains
